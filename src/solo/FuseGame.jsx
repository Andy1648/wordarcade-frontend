...
export default function FuseGame({ onExit, audioSlot = null }) {
  ...
  return <FuseInner data={data} createEngine={createEngine} adapter={adapter} onExit={onExit} audioSlot={audioSlot} />;
}

function FuseInner({ data, createEngine, adapter, onExit, audioSlot }) {
