...
// 10,000 it abbreviates to one decimal with a K/M/B/T suffix, so a value never shows more
// than 5 characters before the suffix (e.g. 14.3K, 2.2M, 999.9K, and 999,999 → 1.0M).
