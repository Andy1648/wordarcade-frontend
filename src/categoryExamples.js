...
export const CATEGORY_EXAMPLES = {
  ...
  'Things on a CVS receipt': 'coupons',
  ...
  'Things you find between couch cushions': 'loose change',
  'Things in a hotel minibar': 'tiny pretzels',
  'Things taped to a fridge': 'grocery list',
  // Food but make it specific
  "McDonald's menu items": 'McFlurry',
  'Things you dip in ranch': 'pizza',
  'Foods that are better cold the next day': 'cold pizza',
  "Gas station food you'd actually eat": 'beef jerky',
  'Things you put on toast': 'butter',
  ...
  'Things you pretend to understand': 'taxes',
