...
export const LADDER = [
  ...
  { level: 7, id: 'theme-midnight', name: 'MIDNIGHT', kind: 'theme' },
  { level: 11, id: 'frame-tape', name: 'TAPE', kind: 'frame' },
  { level: 15, id: 'theme-sunset', name: 'SUNSET', kind: 'theme' },
  { level: 19, id: 'frame-chrome', name: 'CHROME', kind: 'frame' },
  { level: 23, id: 'theme-toxic', name: 'TOXIC', kind: 'theme' },
  { level: 27, id: 'frame-spike', name: 'SPIKE', kind: 'frame' },
  { level: 31, id: 'theme-vapor', name: 'VAPOR', kind: 'theme' },
  { level: 35, id: 'frame-gold', name: 'GOLD', kind: 'frame' },
  { level: 40, id: 'theme-prism', name: 'PRISM', kind: 'theme' },
];

export const MAX_LADDER_LEVEL = LADDER[LADDER.length - 1].level; // 40
...
export function rebirthUnlock(r) {
  ...
  return { rebirth: n, id: `rebirth-${n}`, name: `PRESTIGE ${n}`, kind: n % 2 === 1 ? 'frame' : 'theme' };
}
