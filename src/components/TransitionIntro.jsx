...
export default function TransitionIntro({ onComplete }) {
  ...
  // (title, bg) snaps to black, then the word punches in out of the dark.
  ...
  return (
    <div className="intro-overlay" aria-hidden="true" ref={overlayRef}>
      {/* No background scene - the calm black field is the whole point. The two
          lines slam against it; the only other motion is the impact flash and
          the card shake. */}
