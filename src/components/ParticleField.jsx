...
const PARTICLES = [
  { left: 6,  size: 4, dur: 14, delay: 0,   color: '#ff4fa3', op: 0.13 },
  ...
  { left: 60, size: 3, dur: 19, delay: 10,  color: '#ff4fa3', op: 0.13 },
  ...
  { left: 48, size: 3, dur: 23, delay: 12,  color: '#ff4fa3', op: 0.10 },
];
